<%-- 
    Document   : crm
    Created on : 30 thg 5, 2023, 21:54:00
    Author     : phangiabao
--%>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body"><b><%=thiSinhDAO.countTS()%></b> thí sinh ĐKTS</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="admin?hanhDong=danh-sach-xet-tuyen">View Details</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body"><b><%=thiSinhDAO.countNE()%></b> thí sinh đã ĐK nhập học</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="admin?hanhDong=danh-sach-xet-tuyen">View Details</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
